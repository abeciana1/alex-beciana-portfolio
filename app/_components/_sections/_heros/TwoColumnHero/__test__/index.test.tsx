...
describe('TwoColumnHero', () => {
  beforeEach(() => {
    render(
      <TwoColumnHero
        ...
        gradientBlur={false}
        image={{
          src: '@/public/profile-callout-edited.webp',
          alt: 'test image',
  ...
  it('should render the body text', () => {
    const bodyText = screen.getByText("I'm Alex Beciana, a passionate software engineer with a background in user experience design. I've recently launched my first web application called 'Project Kanban', which aims to help you manage your projects efficiently.")
